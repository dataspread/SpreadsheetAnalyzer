...
import org.dataspread.sheetanalyzer.dependency.util.CalcRefManager;
import org.dataspread.sheetanalyzer.dependency.util.RefUtils;
import org.dataspread.sheetanalyzer.util.CalcQueryException;
...
public class DepencencyGraphCalc implements DependencyGraph {
    ...
    private Set<Ref> getNeighbors(Ref ref) {
        ...
        // }
        // return neighbors;
        return _refManager.findOverlap(ref);
    }
    ...
    private void insertMemEntry(Ref prec, Ref dep) {
        ...
        _refManager.insert(prec);
        _refManager.insert(dep);
    ...
    private void deleteMemEntry(Ref prec, Ref dep) {
        ...
        _refManager.delete(prec);
        _refManager.delete(dep);
    }
